...
export default defineConfig({
  ...
  grepInvert:
    /All screens\/tabs match supplied APK exactly|Complete modules preserved with new dashboard|Step 2 retains complete screens|Step 3 retains complete screens/,
  timeout: 180000,
  expect: { timeout: 10000 },
  workers: 1,
  reporter: [["list"]],
  outputDir: "../../.cache/appointments-tests",
  use: {
    baseURL: process.env.COMPLETE_URL || "http://127.0.0.1:5177",
