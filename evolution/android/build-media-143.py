...
BUNDLE_SHA = '52dfc705decbe96aeab078188240d910092cae0fa257e469e1b6f098fcf4f2c4'
...
APK = ROOT / 'downloads/Yanis-Fitness-Evolution-1.4.3.apk'
...
def main():
    ...
    report = {
        ...
        'packagedWebDifference': 'V 1.4.2 -> V 1.4.3: same aquatic correction, plus a forgotten strength session is now closed automatically at the next day instead of blocking the program and the timers',
        ...
        'supersedes': {'apk': 'downloads/Yanis-Fitness-Evolution-1.4.2.apk',
                       'reason': 'same identity and same aquatic correction; this build adds the forgotten-workout fix'},
        'installNote': 'same package AND same signature as 1.4.2: installs straight over 1.4.2 without uninstalling; coming from 1.4.0 or 1.4.1, uninstall first and restore the JSON backup'}
