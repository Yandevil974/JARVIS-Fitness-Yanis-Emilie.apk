...
PRIVATE = ROOT / '.private/yanis-fitness-evolution-home'
IDENTITY = ROOT / 'evolution/android/identity-home.json'
ENCRYPTED = ROOT / 'evolution/signing/evolution-home.encrypted.json'
ARCHIVE = 'Yanis-Fitness-Evolution-1.4-SAUVEGARDE-PRIVEE.zip'
...
def initialize(private=PRIVATE, identity_path=IDENTITY, encrypted_path=ENCRYPTED):
    approval = json.loads((ROOT / 'evolution/android/home-authorization.json').read_text())
    if approval.get('selectedOption') != 'Oui, on y va' or approval.get('subsequentUserMessage') != 'Poursuis':
        raise ValueError('Explicit parallel-installation authorization missing')
    ...
    try:
        ...
        identity = {'appId': APP_ID, 'appName': 'Yanis Fitness Evolution',
                    ...
                    'previousCertificateSha256': '4d4fbd84463300631bb19e0186f4efc51c589a2e27da1ab56dc1f1ad5479e7dc',
