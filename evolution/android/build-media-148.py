...
def main():
    ...
    report = {
        ...
        'providedAnimations': {'guides': {'Gainage au bord (vertical)': '/media/gainage-vertical.gif',
                       ...
                       'verifiedBy': ['evolution/media/tests/pool-land-guides.spec.mjs','evolution/media/tests/delivered-bundle.test.mjs']},
        'aliasVariants': {'request': 'user, 24 September 2026: complete tous les elements manquants (variantes sans dessin fidele)',
                       ...
                       'verifiedBy': ['evolution/media/tests/alias-visuals.test.mjs','evolution/media/tests/pool-candidate.test.mjs','evolution/media/tests/delivered-bundle.test.mjs']},
        'tabataLandAnimations': {'request': 'user, 24 September 2026: oui complete tous les elements manquants',
                       ...
                       'verifiedBy': ['evolution/media/tests/tabata-land-media.test.mjs','evolution/media/tests/media-inventory.test.mjs','evolution/media/tests/delivered-bundle.test.mjs']},
        'poolRecoveries': {'request': 'user, 24 September 2026: one single complete version, all missing media',
                       ...
                       'measuredOnDeliveredScript': 'le script extrait de cet APK resout les 420 etapes : 117 pool-repos.gif, 18 pool-en-place.gif, zero chemin cardio/elliptique/photo',
                       ...
                       'verifiedBy': ['evolution/media/tests/pool-candidate.test.mjs','evolution/media/tests/media-inventory.test.mjs','evolution/media/tests/delivered-bundle.test.mjs']},
        'stretchVisuals': {'request': 'user, 24 September 2026: one single complete version, all missing media',
                       ...
                       'verifiedBy': ['evolution/media/tests/stretch-media.test.mjs','evolution/media/tests/media-inventory.test.mjs','evolution/media/tests/delivered-bundle.test.mjs']},
