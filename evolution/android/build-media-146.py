...
BUNDLE_SHA = 'e372a369688d924b242d9f269d2293f462b9a2e89fd1843da405fd1055d65292'
...
APK = ROOT / 'downloads/Yanis-Fitness-Evolution-1.4.6.apk'
...
def main():
    ...
    report = {
        ...
        'packagedWebDifference': 'V 1.4.5 -> V 1.4.6: same corrections, plus two stretch visuals now show the described posture (image exchanged, instruction untouched) and five aquatic guides no longer display a land drawing (explicit gap, aquatic instructions kept)',
        ...
        'supersedes': {'apk': 'downloads/Yanis-Fitness-Evolution-1.4.5.apk',
                       'reason': 'same identity and corrections; this build adds the two approved stretch visual exchanges and the explicit gaps for five land-visual aquatic guides'},
        ...
        'installNote': 'same package AND same signature as 1.4.5/1.4.4/1.4.3/1.4.2: installs straight over 1.4.5 without uninstalling; coming from 1.4.0 or 1.4.1, uninstall first and restore the JSON backup'}
