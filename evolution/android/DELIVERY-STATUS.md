...
- **Version de travail en cours** (elle sera remplacée par la version complète demandée le 24 septembre) : 20 animations du **Tabata au sol** + 5 noms équivalents, soit **25 des 38 noms** du générateur au sol ; APK de contrôle `0b5f2ee4…`, 26 607 371 octets, 27 entrées média. Résolution **uniquement** en contexte Tabata au sol (jamais piscine, étirement, échauffement, repos) ; les 13 noms restants sont listés et mesurés par le test, ils gardent l'affichage actuel.
