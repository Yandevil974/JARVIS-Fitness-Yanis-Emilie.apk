...
- Tests : **59/59 Node**, dont `media-inventory.test.mjs` qui mesure **l'APK livré** (présence et empreinte de chaque média), `pool-candidate.test.mjs` (420 étapes, contextes, récupération), `alias-visuals.test.mjs`, `tabata-land-media.test.mjs`, `stretch-media.test.mjs`.
