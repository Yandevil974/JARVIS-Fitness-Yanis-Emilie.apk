...
BUNDLE_SHA = '22109c5be90be9545038cc55f86d7b14f52830b0b7b23b594b571087943c2cb4'
...
APK = ROOT / 'downloads/Yanis-Fitness-Evolution-1.4.4.apk'
...
def main():
    ...
    report = {
        ...
        'packagedWebDifference': 'V 1.4.3 -> V 1.4.4: same corrections, plus the combined-session step durations are written in minutes and seconds instead of raw seconds',
        ...
        'supersedes': {'apk': 'downloads/Yanis-Fitness-Evolution-1.4.3.apk',
                       'reason': 'same identity, aquatic correction and forgotten-workout fix; this build adds the combined-session duration display fix'},
        ...
        'installNote': 'same package AND same signature as 1.4.3/1.4.2: installs straight over 1.4.3 without uninstalling; coming from 1.4.0 or 1.4.1, uninstall first and restore the JSON backup'}
