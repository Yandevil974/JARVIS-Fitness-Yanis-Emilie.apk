...
- Avancement : **181 / 331 animations validées** (`production/etat.json`, clé `chiffres`).
  Restent **150** : musculation 68, piscine (protocoles) 40, tabata au sol 27,
...
1. Reprendre les **2 planches en attente** (`production/a-refaire.json`) : mountain-climbers
   (édition d'une seule case : permuter les jambes, chaussures imposées) et elevations-
   laterales-coude-a-90 (vert exclusif deltoïdes) — `CE-QUI-COINCE.md` §1 ; plus le report
   souleve-de-terre-roumain-halteres (plafond de générations du lot 27). Méthode gagnante sur refus
...
3. Continuer la musculation (68 restants), puis
