...
- Avancement : **174 / 331 animations validées** (`production/etat.json`, clé `chiffres`).
  Restent **157** : musculation 75, piscine (protocoles) 40, tabata au sol 27,
...
1. Reprendre les **2 planches en attente** (`production/a-refaire.json`) : mountain-climbers
   (cases simples au cadrage imposé puis assemblage) et elevations-laterales-coude-a-90
   (départ avant-bras horizontaux) — `CE-QUI-COINCE.md` §1. Méthode gagnante sur refus
...
3. Continuer la musculation (75 restants), puis
