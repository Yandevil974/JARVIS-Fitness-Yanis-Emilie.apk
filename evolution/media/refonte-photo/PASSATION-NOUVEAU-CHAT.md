...
- Avancement : **210 / 331 animations validées** (`production/etat.json`, clé `chiffres`).
  Restent **121** : piscine (protocoles) 40, musculation 39, tabata au sol 27,
...
- Index visuel numéroté : `review/index-general.jpg` (210 vignettes, régénéré à chaque lot).
...
1. Reprendre la **planche en attente** (`production/a-refaire.json`) : developpe-incline-halteres
   (2ᵉ refus, lot 32 en cases simples séparées + assemblage PIL) ; mountain-climbers résolue au lot 31
   par la vue de FACE. Anciennement en attente : mountain-climbers
