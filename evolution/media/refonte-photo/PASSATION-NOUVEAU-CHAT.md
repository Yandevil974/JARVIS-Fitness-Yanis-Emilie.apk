...
- Avancement : **188 / 331 animations validées** (`production/etat.json`, clé `chiffres`).
  Restent **143** : musculation 61, piscine (protocoles) 40, tabata au sol 27,
...
1. Reprendre les **2 planches en attente** (`production/a-refaire.json`) : mountain-climbers
   (dernier essai généré, sinon décision utilisateur listée dans `CE-QUI-COINCE.md` §1) et
   elevations-laterales-coude-a-90 (prompt sans texte, exactement deux haltères). Méthode gagnante sur refus
...
3. Continuer la musculation (61 restants), puis
