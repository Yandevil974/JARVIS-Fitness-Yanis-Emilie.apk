...
- Avancement : **195 / 331 animations validées** (`production/etat.json`, clé `chiffres`).
  Restent **136** : musculation 54, piscine (protocoles) 40, tabata au sol 27,
...
1. Reprendre les **3 planches en attente** (`production/a-refaire.json`) : mountain-climbers
   (suspendu à la décision utilisateur), elevations-laterales-coude-a-90 (cases simples
   séparées puis assemblage), releves-de-jambes-incline (sans chaussures en double). Méthode gagnante sur refus
...
3. Continuer la musculation (54 restants), puis
