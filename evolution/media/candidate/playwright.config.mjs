...
export default defineConfig({
 testDir:'../tests',testMatch:['pool-candidate.spec.mjs','warmup-candidate.spec.mjs','emilie-session-block.spec.mjs','tabata-context.spec.mjs'],workers:1,timeout:45000,
