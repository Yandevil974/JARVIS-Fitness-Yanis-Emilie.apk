...
export function TimerModal() {
  ...
  function complete() {
    ...
    if (t.meta.type === "warmup") {
      updateProfile((q) => {
        // A standalone/restored warmup has no workoutId. Without the
        // explicit workout guard, undefined === undefined dereferences null
        // and unmounts the whole application during the state update.
        if (q.workout && t.meta.workoutId && q.workout.id === t.meta.workoutId)
