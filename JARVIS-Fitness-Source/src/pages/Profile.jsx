  ...
  async function notifications(v) {
    if (v && "Notification" in window) {
      ...
      if (permission !== "granted") {
        notify(
          "Notifications système non autorisées. Les alertes dans l’application restent disponibles.",
          "info",
        );
        return;
      }
      ...
      notify(
        "Ce navigateur ne propose pas les notifications système ici.",
        "info",
      );
      return;
    }
    updateProfile((q) => {
      q.preferences.notifications = v;
    });
  }
  return (
    <div className="preferences-layout">
      ...
      <div>
        ...
        <Panel className="future-connections">
          <SectionHeading
            title="Ouvert aux prochaines connexions"
            subtitle="Architecture prête à évoluer. Aucun capteur n’est connecté."
          />
          {[
            ["Watch", "Montre connectée"],
            ["HeartPulse", "Fréquence cardiaque"],
            ["Moon", "Données de sommeil"],
          ...
          <p>
            Les futurs connecteurs doivent passer par des adaptateurs et votre
            consentement. Aucune donnée de capteur n’est simulée.
          </p>
        </Panel>
      </div>
    </div>
