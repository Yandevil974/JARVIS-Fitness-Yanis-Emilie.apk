# BLOC À COPIER-COLLER DANS UN NOUVEAU CHAT — lot 64, 26 septembre 2026
...
Lire dans l'ordre :
1. evolution/media/refonte-photo/PASSATION-NOUVEAU-CHAT.md (état prioritaire lot 64, recette, pièges ; anciens compteurs historiques).
2. CE-QUI-COINCE.md (§0 feuille de route utilisateur, §1 reprises, §3 décisions).
3. evolution/media/refonte-photo/verification/VERIFICATION-2026-09-25.md §66–81.
...
Détails VERIFICATION §81. Aucun APK reconstruit ce tour ; documents/registre seuls et propositions isolées.
