# Installation de Yanis Fitness Evolution 1.4.4 (23 septembre 2026)

Cette version corrige **la séance oubliée qui bloquait Émilie** et **les durées illisibles de la modale de séance combinée** (« 1500 s » devient « 25 min ») : une séance de
...
La 1.4.4 contient aussi la correction piscine de la 1.4.1/1.4.2 : les étapes
...
| Fichier | Rôle |
| --- | --- |
| `Yanis-Fitness-Evolution-1.4.4.apk` | application à installer (24 909 293 octets) |
| `Yanis-Fitness-Evolution-1.4.4.apk.sha256` | empreinte de contrôle |
| `Yanis-Fitness-Evolution-1.4.4.fidelity.json` | inventaire de fidélité (ce qui change, ce qui ne change pas) |
...
Téléchargements :
[APK 1.4.4](https://raw.githubusercontent.com/Yandevil974/JARVIS-Fitness-Yanis-Emilie.apk/PLACEHOLDER/downloads/Yanis-Fitness-Evolution-1.4.4.apk) ·
[empreinte](https://raw.githubusercontent.com/Yandevil974/JARVIS-Fitness-Yanis-Emilie.apk/PLACEHOLDER/downloads/Yanis-Fitness-Evolution-1.4.4.apk.sha256) ·
[inventaire de fidélité](https://raw.githubusercontent.com/Yandevil974/JARVIS-Fitness-Yanis-Emilie.apk/PLACEHOLDER/downloads/Yanis-Fitness-Evolution-1.4.4.fidelity.json)

## Installation selon votre version actuelle

- **Vous avez déjà installé la 1.4.2 ou la 1.4.3** : même identifiant d'application **et
  même signature**. Installez directement la 1.4.4 **par-dessus**, sans rien désinstaller :
...
- **Vous êtes encore en 1.4.0 ou 1.4.1** : la signature est différente, Android
  ...
  3. installer la 1.4.4 ;
  4. restaurer le JSON.

Vérification facultative sur un ordinateur :

```
sha256sum Yanis-Fitness-Evolution-1.4.4.apk
