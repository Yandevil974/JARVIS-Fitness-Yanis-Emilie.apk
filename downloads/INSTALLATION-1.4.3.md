# Installation de Yanis Fitness Evolution 1.4.3 (23 septembre 2026)

Cette version corrige **la séance oubliée qui bloquait Émilie** : une séance de
...
La 1.4.3 contient aussi la correction piscine de la 1.4.1/1.4.2 : les étapes
...
| Fichier | Rôle |
| --- | --- |
| `Yanis-Fitness-Evolution-1.4.3.apk` | application à installer (24 909 288 octets) |
| `Yanis-Fitness-Evolution-1.4.3.apk.sha256` | empreinte de contrôle |
| `Yanis-Fitness-Evolution-1.4.3.fidelity.json` | inventaire de fidélité (ce qui change, ce qui ne change pas) |

Empreinte SHA-256 de l'APK :

```
31e950848b0379830c09e9a4061eab49c812869343050747a0e163944941141c
```

Téléchargements :
[APK 1.4.3](https://raw.githubusercontent.com/Yandevil974/JARVIS-Fitness-Yanis-Emilie.apk/COMMIT_PLACEHOLDER/downloads/Yanis-Fitness-Evolution-1.4.3.apk) ·
[empreinte](https://raw.githubusercontent.com/Yandevil974/JARVIS-Fitness-Yanis-Emilie.apk/COMMIT_PLACEHOLDER/downloads/Yanis-Fitness-Evolution-1.4.3.apk.sha256) ·
[inventaire de fidélité](https://raw.githubusercontent.com/Yandevil974/JARVIS-Fitness-Yanis-Emilie.apk/COMMIT_PLACEHOLDER/downloads/Yanis-Fitness-Evolution-1.4.3.fidelity.json)

## Installation selon votre version actuelle

- **Vous avez déjà installé la 1.4.2** : même identifiant d'application **et même
  signature**. Installez directement la 1.4.3 **par-dessus**, sans rien désinstaller :
...
- **Vous êtes encore en 1.4.0 ou 1.4.1** : la signature est différente, Android
  ...
  3. installer la 1.4.3 ;
  4. restaurer le JSON.

Vérification facultative sur un ordinateur :

```
sha256sum Yanis-Fitness-Evolution-1.4.3.apk
# doit afficher 31e950848b0379830c09e9a4061eab49c812869343050747a0e163944941141c
```
